...
<title>Genre : Admin - Cpanel</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#datacontent").load("db_sql/genres.php", Hide_Load());
	//Pagination Click
...
<div class="wrap">
	...
	<div id="content">
		<div id="sidebar">
			<div class="box">
				<div class="h_title">&#8250; Genres</div>
				<ul id="home">
					<li class="b1"><a class="icon films" href="">View</a></li> 
					<li class="b1"><a class="icon add_page" href="forms/genres.php">Add new</a></li>
				</ul>
			</div>
	...
	<div id="footer">
		...
		<div class="right">
			<p><a href="">Colombo Today.com</a></p>
		</div>
	</div>
</div>
